...
launch_name = "/home/lrd/ROS_WS/zhongqi_ws/src/position_optimization/launch/trans.launch"
map_server_name = "/home/lrd/ROS_WS/zhongqi_ws/src/zhongqi_navigation/launch/zhongqi_navigation.launch"
...
#         name2 = child.get('args')
         ...
         path = '/home/lrd/map/' + map_name + '.yaml'
         child.set('args',path)
#         print(path)        
#         print(map_name)
